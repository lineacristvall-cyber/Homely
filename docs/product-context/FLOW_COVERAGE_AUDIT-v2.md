# Homely UI flow coverage audit

Version 2 is the production-oriented **proposed** finite screen/action contract. The [editable atlas](flows/Homely-UI-State-Atlas-v2.drawio) has 25 pages (one clickable start index plus S01–S24), 323 explicit action/event transitions and 214 validated in-file page links. The rejected high-level [v1](flows/Homely-experience-v1.drawio) is retained for provenance. Each action ID appears as a row in XML.

| Page | Screen | Action IDs | UI states referenced | Cross-screen destinations |
| --- | --- | --- | --- | --- |
| S01 | Welcome & intent | S01-A01…A11 (11) | 5 | S03, S20 |
| S02 | Permissions at point of use | S02-A01…A13 (13) | 3 | S04, S05, S07, S19 |
| S03 | Project home & session | S03-A01…A13 (13) | 4 | S01, S04, S05, S15, S19, S20, S22, S23 |
| S04 | Room canvas & voice | S04-A01…A14 (14) | 4 | S02, S03, S05, S07 |
| S05 | Capture, edit & dimensions | S05-A01…A18 (18) | 10 | S02, S04, S06, S07 |
| S06 | Taste & inspiration | S06-A01…A11 (11) | 5 | S04, S07 |
| S07 | Structured brief & constraints | S07-A01…A12 (12) | 5 | S04, S08 |
| S08 | Research job & progress | S08-A01…A15 (15) | 6 | S07, S09, S10, S19, S23 |
| S09 | No result & source gap | S09-A01…A09 (9) | 3 | S03, S07, S08, S10, S12, S19 |
| S10 | Findings & spoken briefing | S10-A01…A16 (16) | 6 | S08, S11, S12, S14, S18, S19 |
| S11 | Exact candidate evidence | S11-A01…A16 (16) | 7 | S05, S10, S13, S14, S16, S18 |
| S12 | Unconfirmed lead | S12-A01…A09 (9) | 4 | S10, S11, S19 |
| S13 | Actual product in room | S13-A01…A16 (16) | 6 | S05, S11, S14 |
| S14 | Mobile comparison | S14-A01…A13 (13) | 4 | S10, S11, S12, S13, S16 |
| S15 | Desktop project canvas | S15-A01…A13 (13) | 3 | S03, S04, S05, S07, S08, S20, S23, S24 |
| S16 | Decision, budget & stock gate | S16-A01…A14 (14) | 6 | S14, S17, S18, S20 |
| S17 | External seller handoff & earned usage | S17-A01…A11 (11) | 5 | S16, S18, S21 |
| S18 | Stock-change alert & replacement | S18-A01…A10 (10) | 3 | S09, S11, S12, S16, S19 |
| S19 | Saved hunts & notification inbox | S19-A01…A15 (15) | 7 | S02, S03, S07, S18, S23 |
| S20 | Client share, approval & revisions | S20-A01…A15 (15) | 7 | S03, S07, S13, S16 |
| S21 | Decision & purchase ledger | S21-A01…A11 (11) | 6 | S03, S07 |
| S22 | Account, privacy & data | S22-A01…A16 (16) | 7 | S01, S03, S19, S21 |
| S23 | Offline, reconnect & conflicts | S23-A01…A17 (17) | 7 | S03, S04, S08, S15, S16, S19 |
| S24 | Desktop research workspace | S24-A01…A15 (15) | 5 | S09, S11, S12, S13, S14, S15, S18, S20, S23 |

## Coverage contract

The screen specification gives user journeys, data lifecycles, platform/privacy constraints and acceptance criteria. This atlas makes the UI affordance and destination of each action explicit. Each row handles a distinct material behavior, not every possible combination of product/source failure, geography and device. The product remains unbuilt; stock confirmation, source access and visualization fidelity require validation.

Shared keyboard/screen-reader interaction patterns and responsive layout are specified in [SCREEN_STATE_SPEC.md](SCREEN_STATE_SPEC.md) and [PRODUCT_UX_CONCEPT.md](PRODUCT_UX_CONCEPT.md). Permission and offline branches are screens S02/S23, invoked explicitly from relevant screens. Consent, deletion, commerce and credits must be refined with product/legal decisions before implementation.

## Known decisions and boundaries for design review

- Exact stock evidence freshness policies and integration rights are not approved. A seller assertion is evidence to evaluate, not a guaranteed reservation.
- Visualization quality and geometry threshold require measured-room, real-SKU trials; mockups do not prove fidelity.
- Client sharing roles, photo retention and permanent-deletion mechanics need explicit product decisions.
- Pro seat, DIY pass and affiliate/hybrid monetization are candidate models; credit release is conditional on contractual and realized commission.
- Native hands-free behavior, push/background sync and camera measurement vary by browser/OS; the PWA must fall back to silent/manual/in-app interaction.


## Requirement-to-screen map

| Requirement | Screen/action area |
| --- | --- |
| Session, pro/DIY intent, auth, deep links | S01, S03, S20 |
| Permission request/denial/revocation and silent equivalence | S02, S04, S05, S19 |
| Photo capture/edit/delete, retained pieces, geometry | S04–S05, S15 |
| Voice listen/transcribe/correct/interrupt/undo | S04, S07, S15 |
| Taste, constraints, quantity, hard cap versus target | S06–S07, S14, S16 |
| Research job, source gaps, pause/resume, empty/partial | S08–S10, S19, S24 |
| Filters, sort and differentiated alternatives | S10, S14, S24 |
| Exact variant, quantity, freshness, provenance and leads | S11–S12, S16, S18 |
| Real-item placement, edit/swap, lineage, fit/error | S13, S15 |
| Shortlist, all-in logistics, seller recheck | S14, S16–S17, S24 |
| Saved hunts, notification controls and replacement | S18–S19 |
| Pro share, client approval, revisions/revocation | S20–S21 |
| Purchase unknown, attribution, earned credits/reversal | S17, S21–S22 |
| Privacy/export/delete, offline/reconnect/conflicts | S22–S23 |
| Keyboard, assistive tech, responsive PWA fallbacks | Shared contract in SCREEN_STATE_SPEC.md; S02, S04, S15, S23 |

## Complete action/transition ledger

This ledger is generated from the exact same rows as the editable diagram. Cross-screen targets are checked against named states in the destination page.

### S01 · Welcome & intent

| Action ID | From state | Visible control or event | Guard and feedback | Destination |
| --- | --- | --- | --- | --- |
